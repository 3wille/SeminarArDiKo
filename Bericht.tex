...
Diese Informationen speichert jeder Knoten oder auch Router in einer lokalen Routing-Tabelle, die er wie folgt befüllt. \cite{weLSRP}
...
Erreicht der Alterszähler den Wert 0, wird das Paket verworfen. \cite{AndrewS.Tanenbaum2010}
...
Erreicht ein Paket eines anderen Routers den Router aber über zwei oder mehr unterschiedliche Leitungen, so wird auf all diesen Leitungen das \ac{ack} Flag gesetzt und das Send Flag auf den verbleibenden Leitungen. \cite{AndrewS.Tanenbaum2010}
...
\label{fig:ospf-area}
\end{figure}
\footnotetext{Quelle: \cite{ospfDesign}}
