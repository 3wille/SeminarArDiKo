...
Innerhalb eines Netzes müssen Routen von jedem Rechner zu jedem anderen Rechner gefunden werden. Über ein \ac{igp} kommunizieren die Router des Netzes die von ihnen erreichbaren Rechner. Meistens sind Gateways auch Router für das interne Netz.
